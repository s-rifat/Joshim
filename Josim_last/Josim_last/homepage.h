...
void home()
{
	...
	if (kemne_khelmu_screen) //kemne_khelmu_screen
	{
		iShowImage(0, 0, screenwidth, screenheight, descriptionBC);//description
		iShowBMPAlternativeSkipRed(0, 100, "RED\\j\\s\\5.bmp");
		
		iShowBMPAlternativeSkipRed(600, 100, "RED\\d\\s\\1.bmp");
		//description();
	}
...
void loadHomeImage()
{
	...
	*/
	...
	menu = iLoadImage("images\\menu1.jpg");// home manu background

	scoreBC = iLoadImage("images\\highscore.jpg");// scoreboard background

	descriptionBC = iLoadImage("images\\kmne_khelmu.jpg");// descriptionbord background

	amago_chenos = iLoadImage("images\\amago_chenos2.jpg");// amago chenos page

	roundBC1 = iLoadImage("images\\background1b.jpg");//play background

	roundBC2 = iLoadImage("images\\Bg2.jpg");//play background

	roundBC3 = iLoadImage("images\\2.jpg");//play background
